...
export const LIKE = {
  ...
  UPDOWN: "up",
  ATTITUDE_LIKE_DISLIKE: "attitude-like",
};

export const DISLIKE = {
  LIKEDISLIKE: USER_VIEW_LABELS.DISLIKE,
  UPDOWN: "down",
  ATTITUDE_LIKE_DISLIKE: "attitude-dislike",
};

export const DEF = { likeDislike: false, upDown: "", attitudeLikeDislike: "" };

export const ATTITUDE_MESSAGES = {
  LIKE: "You like this user",
  DISLIKE: "You dislike this user",
};

export const ATTITUDE_ICONS = {
