...
export const EVENTS_API_SERVICES = {
  FUTURE_EVENTS: apiService.getFutureEvents,
  PAST_EVENTS: apiService.getPastEvents,
  VISITED_EVENTS: apiService.getVisitedEvents,
  TODO_EVENTS: apiService.getEventsToGo,
};

export const SET_COPY_EVENT = {
  SET_COPY_EVENT_PENDING: "SET_COPY_EVENT_PENDING",
  SET_COPY_EVENT_SUCCESS: "SET_COPY_EVENT_SUCCESS",
};

export const SET_EVENT = {
  SET_EVENT_PENDING: "SET_EVENT_PENDING",
  SET_EVENT_SUCCESS: "SET_EVENT_SUCCESS",
};

export const SET_CANCEL_ALL_EVENT = {
  SET_CANCEL_ALL_EVENT_PENDING: "SET_CANCEL_ALL_EVENT_PENDING",
  SET_CANCEL_ALL_EVENT_SUCCESS: "SET_CANCEL_ALL_EVENT_SUCCESS",
};

export const SET_CANCEL_NEXT_EVENT = {
