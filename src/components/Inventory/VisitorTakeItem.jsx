...
const VisitorEditItemForm = ({
  ...
  const maxValueLimitor = maxValue(initialValues.needQuantity - alreadyGet);

  const minValueLimitor = minValue(1);
    ...
    <form onSubmit={handleSubmit} className="form-inline w-100">
      ...
      <div className="col col-md-1 d-flex align-items-center">
        <Field
          ...
          type="number"
          fullWidth={false}
          validate={[maxValueLimitor, minValueLimitor]}
          label="Will take"
