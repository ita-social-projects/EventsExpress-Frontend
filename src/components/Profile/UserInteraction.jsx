...
import { NEGATIVE_ATTITUDE } from "../../constants/userConstants";
...
const UserInteraction = ({ attitude, onLike, onReset, onDislike, id }) => {
  return (
    <div className="row justify-content-center">
      ...
      >
        <IconButton
          className={attitude === NEGATIVE_ATTITUDE ? "text-danger" : ""}
          onClick={attitude !== NEGATIVE_ATTITUDE ? onDislike : onReset}
        >
